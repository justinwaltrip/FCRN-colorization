...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        pretrain(train_loader, model, criterion, optimizer, epoch, logger)  # train for one epoch
        result, img_merge = prevalidate(val_loader, model, criterion, epoch, logger)  # evaluate on validation set
...
# train
def pretrain(train_loader, model, criterion, optimizer, epoch, logger):
...
def prevalidate(val_loader, model, criterion, epoch, logger):
    ...
    wandb.log({"epoch": epoch, "validation loss": val_loss/len(val_loader)})
